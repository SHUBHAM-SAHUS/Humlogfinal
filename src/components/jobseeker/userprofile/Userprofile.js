...
export const Userprofile = (props) => {
  ...
  useEffect(() => {
    if (!loaded) {
      setLoaded(true);
      dispatch(userActions.getUserDataBySarthi(userId));
        ...
        <div className="container">
          ...
          <div className="row p-0 m-0 no-gutters">
            <div className="col-12 mt-2">
              ...
              {userDetailsById &&
                      ...
                      userDetailsById.about_me.length > 0? "I am" +" ":
                       ""}
                ...
                <div>
                  ...
                  <h4 className="text-left  user_tt mt-2">
                    {userDetailsById && userDetailsById.qualification === 0
                      ...
                      ? "Graduation & above"
                      : userDetailsById && userDetailsById.qualification === 4
                      ? "12 +ITI"
                      : userDetailsById && userDetailsById.qualification === 5
                      ? "Graduation + ITI"
                      : userDetailsById && userDetailsById.qualification === 6
                      ? "12 + Diploma"
                      : userDetailsById && userDetailsById.qualification === 7
                      ? "Grad + Diploma"
                      : ""}
                  </h4>
          ...
          <div className="row p-0 m-0 no-gutters">
            <div className="col-12">
              ...
              <a
                className="word_brk"
                href={userDetailsById && userDetailsById.video_resume}
              >
